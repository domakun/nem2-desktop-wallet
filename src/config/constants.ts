...
export const WALLET_VERSION = '0.8.11'
...
export const transactionTag = {
  RECEIPT: 'receipt',
  PAYMENT: 'payment',
  [TransactionType.NAMESPACE_REGISTRATION]: 'register_namespace',
  ...
  [TransactionType.MULTISIG_ACCOUNT_MODIFICATION]: 'modify_multisig_account',
  [TransactionType.AGGREGATE_COMPLETE]: 'aggregate_complete',
  [TransactionType.AGGREGATE_BONDED]: 'aggregate_bonded',
  [TransactionType.HASH_LOCK]: 'lock',
  [TransactionType.SECRET_LOCK]: 'secret_lock',
  [TransactionType.SECRET_PROOF]: 'secret_proof',
  [TransactionType.ACCOUNT_ADDRESS_RESTRICTION]: 'account_restriction_address',
  [TransactionType.ACCOUNT_MOSAIC_RESTRICTION]: 'account_restriction_mosaic',
  [TransactionType.ACCOUNT_OPERATION_RESTRICTION]: 'account_restriction_operation',
  [TransactionType.ACCOUNT_LINK]: 'link_account',
  ...
  [TransactionType.ACCOUNT_METADATA]: 'account_metadata_transaction',
  [TransactionType.MOSAIC_METADATA]: 'mosaic_metadata_transaction',
  [TransactionType.NAMESPACE_METADATA]: 'namespace_metadata_transaction',
}
