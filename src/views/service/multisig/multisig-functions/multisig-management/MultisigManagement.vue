<template>
  <div class="multisig_management_container scroll secondary_page_animate" @click="showSubpublickeyList = false">
    ...
    <div class="cosigner_list">
      ...
      <div class="list_container radius">
        <div class="list_head">
          ...
          <span class="delta>{{$t('delete')}}</span>
        </div>
        <div class="list_body scroll">
          ...
          <div class="list_item radius" v-for="(i,index) in formItem.cosignerList">
            ...
            <img class="delta pointer" @click="removeCosigner(index)"
    ...
    <div class=" no_multisig pointer" v-else>
