...
// wallet detail
    ...
    // wallet create
    choose_network: '选择网络',
    In_the_nem2_ecosystem_you_can_build_your_own_home_wallet_or_private_network_wallet_or_test_the_network_such_as_Main_net_Test_net_different_wallet_address_prefixes_generated_under_different_networks: 'nem2 的生态系统中，你可以构建自己的主网钱包，或者私用网络钱包，或者测试网络',
...
//mosaic transaction
    ...
    multisig: '多重签名',
    NEM_account_can_be_converted_to_multiple_accounts_multisig: 'NEM帐户可以转换为多重账户multisig。 multisig的共同签署人（Cosignatories）将成为帐户管理员。Multisig帐户需要其他签名才能 启动操作/转移。',
    Since_then_multisig_accounts_have_not_been_able_to_announce_transactions_on_their_own: '从那时起，multisig帐户无法自行宣布交易。多重签名的委托人必须 提出涉及多重签名的交易要在区块中记录交易，其他签署人必须同意，NEM当前对multisig的实现是“ M-of-N”（M>=N）',
    note: '注意',
    The_Multisig_account_is_a_powerful_tool_but_please_use_this_tool_with_caution: 'Multisig帐户是一个功能强大的工具，但请谨慎使用此工具。',
    If_the_signer_key_is_lost_and_the_minimum_approval_requirement_is_not_met: '如果签名人的密钥丢失并且未达到最低批准要求，则将导致永久失去 对multisig帐户所持有资金的访问权限。谨慎地选择最小去除参数以避免这种情况。',
    multisig_account:'多重账户',
    Multisig_account_requires_additional_signatures_to_initiate_an_action_transfer :'Multisig 帐户需要其他签名才能启动操作/转移',
    public_account:'公共账户',
    current_cosigner:'现有共签账户',
    current_multisig:'现有多签账户',
}
