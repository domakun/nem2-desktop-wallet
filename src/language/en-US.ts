...
//mosaic transaction
    ...
    multisig: 'Multisig',
    NEM_account_can_be_converted_to_multiple_accounts_multisig: 'A NEM account can be converted to multisig. The cosignatories - other accounts - of the multisig will become the account managers. Multisig accounts require additional signatures to initiate actions/transfers.',
    Since_then_multisig_accounts_have_not_been_able_to_announce_transactions_on_their_own: 'From that moment on, the multisig account cannot announce transactions by itself. To record the transaction in the block, the other cosignatories will have to agree. NEM’s current implementation of multisig is “M-of-N”.',
    note: 'Note',
    The_Multisig_account_is_a_powerful_tool_but_please_use_this_tool_with_caution: 'Multisig accounts are a powerful tool, but please use this tool with caution. ',
    If_the_signer_key_is_lost_and_the_minimum_approval_requirement_is_not_met: ' If the cosignatories keys get lost and minimum approval is not reached, it would result in the permanent loss of access to the funds held by the multisig account. Choose wisely minimum removal parameter to avoid this situation.',
    multisig_account: 'Multisig account ',
    Multisig_account_requires_additional_signatures_to_initiate_an_action_transfer: 'Multisig accounts require additional signatures to initiate actions/transfers.',
    public_account: 'Public account',
    current_cosigner: 'Current cosigner',
    current_multisig: 'Current multisig',
}
